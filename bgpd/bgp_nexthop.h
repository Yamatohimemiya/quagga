...
#define NEXTHOP_FAMILY(nexthop_len) (((nexthop_len) == 4 || (nexthop_len) == 12 ? AF_INET : ((nexthop_len) == 16 || (nexthop_len) == 24 || (nexthop_len) == 48 ? AF_INET6 : AF_UNSPEC)))
...
extern int bgp_nexthop_lookup(afi_t, struct peer *peer, struct bgp_info *, int *, int *);
