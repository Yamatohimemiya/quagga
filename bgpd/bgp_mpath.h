...
extern void bgp_info_mpath_update(struct bgp_node *, struct bgp_info *, struct bgp_info *, struct list *, afi_t, safi_t);
extern void bgp_info_mpath_aggregate_update(struct bgp_info *, struct bgp_info *);
