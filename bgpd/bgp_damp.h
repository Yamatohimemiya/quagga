...
extern int bgp_damp_enable(struct bgp *, afi_t, safi_t, time_t, unsigned int, unsigned int, time_t);
extern int bgp_damp_disable(struct bgp *, afi_t, safi_t);
extern int bgp_damp_withdraw(struct bgp_info *, struct bgp_node *, afi_t, safi_t, int);
...
extern const char *bgp_damp_reuse_time_vty(struct vty *, struct bgp_info *, char *, size_t);
