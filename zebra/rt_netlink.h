...
extern int addattr_l(struct nlmsghdr *n, size_t maxlen, int type, void *data, size_t alen);

extern int rta_addattr_l(struct rtattr *rta, size_t maxlen, int type, void *data, size_t alen);
