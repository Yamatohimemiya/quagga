...
void zebra_redistribute_add(int a, struct zserv *b, int c, vrf_id_t vrf_id) {
	return;
}
...
#else
void zebra_redistribute_delete(int a, struct zserv *b, int c, vrf_id_t vrf_id) {
	return;
}

void zebra_redistribute_default_add(int a, struct zserv *b, int c, vrf_id_t vrf_id) {
	return;
}

void zebra_redistribute_default_delete(int a, struct zserv *b, int c, vrf_id_t vrf_id) {
	return;
}
#endif
...
void zebra_interface_address_add_update(struct interface *a, struct connected *b) {
	return;
}
#ifdef HAVE_SYS_WEAK_ALIAS_PRAGMA
	#pragma weak zebra_interface_address_delete_update = zebra_interface_address_add_update
#else
void zebra_interface_address_delete_update(struct interface *a, struct connected *b) {
	return;
}
#endif
