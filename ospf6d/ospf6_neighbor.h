...
#define IS_OSPF6_DEBUG_NEIGHBOR(level) (conf_debug_ospf6_neighbor & OSPF6_DEBUG_NEIGHBOR_##level)
...
struct ospf6_neighbor *ospf6_neighbor_lookup(u_int32_t, struct ospf6_interface *);
struct ospf6_neighbor *ospf6_neighbor_create(u_int32_t, struct ospf6_interface *);
