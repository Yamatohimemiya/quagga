...
#define ospf6_zebra_is_redistribute(type) vrf_bitmap_check(zclient->redist[type], VRF_DEFAULT)

extern void ospf6_distance_reset(struct ospf6 *);
extern u_char ospf6_distance_apply(struct ospf6_route *, struct ospf6 *);
extern int ospf6_distance_set(struct vty *, struct ospf6 *, const char *, const char *, const char *);
extern int ospf6_distance_unset(struct vty *, struct ospf6 *, const char *, const char *);
