...
static void ospf6_top_lsdb_hook_add(struct ospf6_lsa *lsa) {
	switch(ntohs(lsa->header->type)) {
		case OSPF6_LSTYPE_AS_EXTERNAL: ospf6_asbr_lsa_add(lsa); break;
...
static void ospf6_top_lsdb_hook_remove(struct ospf6_lsa *lsa) {
	switch(ntohs(lsa->header->type)) {
		case OSPF6_LSTYPE_AS_EXTERNAL: ospf6_asbr_lsa_remove(lsa); break;
...
static void __attribute__((unused)) ospf6_enable(struct ospf6 *o) {
	struct listnode *node, *nnode;
	struct ospf6_area *oa;
...
void ospf6_maxage_remove(struct ospf6 *o) {
	if(o && !o->maxage_remover) {
		o->maxage_remover = thread_add_timer(master, ospf6_maxage_remover, o, OSPF_LSA_MAXAGE_REMOVE_DELAY_DEFAULT);
	}
}

/* start ospf6 */
DEFUN(router_ospf6, router_ospf6_cmd, "router ospf6", ROUTER_STR OSPF6_STR) {
	if(ospf6 == NULL) {
		ospf6 = ospf6_create();
	}
...
/* stop ospf6 */
DEFUN(no_router_ospf6, no_router_ospf6_cmd, "no router ospf6", NO_STR OSPF6_ROUTER_STR) {
	if(ospf6 == NULL) {
...
DEFUN(ospf6_router_id, ospf6_router_id_cmd, "router-id A.B.C.D", "Configure OSPF Router-ID\n" V4NOTATION_STR) {
	int ret;
	u_int32_t router_id;
	struct ospf6 *o;
...
DEFUN(ospf6_log_adjacency_changes, ospf6_log_adjacency_changes_cmd, "log-adjacency-changes", "Log changes in adjacency state\n") {
...
DEFUN(ospf6_log_adjacency_changes_detail, ospf6_log_adjacency_changes_detail_cmd, "log-adjacency-changes detail",
...
DEFUN(no_ospf6_log_adjacency_changes, no_ospf6_log_adjacency_changes_cmd, "no log-adjacency-changes", NO_STR "Log changes in adjacency state\n") {
	struct ospf6 *ospf6 = vty->index;
...
DEFUN(no_ospf6_log_adjacency_changes_detail, no_ospf6_log_adjacency_changes_detail_cmd, "no log-adjacency-changes detail",
...
DEFUN(ospf6_distance, ospf6_distance_cmd, "distance <1-255>",
...
DEFUN(no_ospf6_distance, no_ospf6_distance_cmd, "no distance <1-255>",
      NO_STR "Define an administrative distance\n"
	     "OSPF6 Administrative distance\n") {
	struct ospf6 *o;
...
DEFUN(no_ospf6_distance_ospf6, no_ospf6_distance_ospf6_cmd, "no distance ospf6",
      NO_STR "Define an administrative distance\n"
	     "OSPF6 Administrative distance\n"
	     "OSPF6 Distance\n") {
	struct ospf6 *o;
...
DEFUN(ospf6_distance_ospf6_intra, ospf6_distance_ospf6_intra_cmd, "distance ospf6 intra-area <1-255>",
...
DEFUN(ospf6_distance_ospf6_intra_inter, ospf6_distance_ospf6_intra_inter_cmd, "distance ospf6 intra-area <1-255> inter-area <1-255>",
      "Define an administrative distance\n"
      "OSPF6 Administrative distance\n"
      "Intra-area routes\n"
      "Distance for intra-area routes\n"
...
DEFUN(ospf6_distance_ospf6_intra_external, ospf6_distance_ospf6_intra_external_cmd, "distance ospf6 intra-area <1-255> external <1-255>",
      "Define an administrative distance\n"
      "OSPF6 Administrative distance\n"
      "Intra-area routes\n"
      "Distance for intra-area routes\n"
...
DEFUN(ospf6_distance_ospf6_intra_inter_external, ospf6_distance_ospf6_intra_inter_external_cmd, "distance ospf6 intra-area <1-255> inter-area <1-255> external <1-255>",
      "Define an administrative distance\n"
      "OSPF6 Administrative distance\n"
      "Intra-area routes\n"
      "Distance for intra-area routes\n"
...
DEFUN(ospf6_distance_ospf6_intra_external_inter, ospf6_distance_ospf6_intra_external_inter_cmd, "distance ospf6 intra-area <1-255> external <1-255> inter-area <1-255>",
      "Define an administrative distance\n"
      "OSPF6 Administrative distance\n"
      "Intra-area routes\n"
      "Distance for intra-area routes\n"
...
DEFUN(ospf6_distance_ospf6_inter, ospf6_distance_ospf6_inter_cmd, "distance ospf6 inter-area <1-255>",
      "Define an administrative distance\n"
      "OSPF6 Administrative distance\n"
      "Inter-area routes\n"
      "Distance for inter-area routes\n") {
...
DEFUN(ospf6_distance_ospf6_inter_intra, ospf6_distance_ospf6_inter_intra_cmd, "distance ospf6 inter-area <1-255> intra-area <1-255>",
      "Define an administrative distance\n"
      "OSPF6 Administrative distance\n"
      "Inter-area routes\n"
      "Distance for inter-area routes\n"
...
DEFUN(ospf6_distance_ospf6_inter_external, ospf6_distance_ospf6_inter_external_cmd, "distance ospf6 inter-area <1-255> external <1-255>",
      "Define an administrative distance\n"
      "OSPF6 Administrative distance\n"
      "Inter-area routes\n"
      "Distance for inter-area routes\n"
...
DEFUN(ospf6_distance_ospf6_inter_intra_external, ospf6_distance_ospf6_inter_intra_external_cmd, "distance ospf6 inter-area <1-255> intra-area <1-255> external <1-255>",
      "Define an administrative distance\n"
      "OSPF6 Administrative distance\n"
      "Inter-area routes\n"
      "Distance for inter-area routes\n"
...
DEFUN(ospf6_distance_ospf6_inter_external_intra, ospf6_distance_ospf6_inter_external_intra_cmd, "distance ospf6 inter-area <1-255> external <1-255> intra-area <1-255>",
      "Define an administrative distance\n"
      "OSPF6 Administrative distance\n"
      "Inter-area routes\n"
      "Distance for inter-area routes\n"
...
DEFUN(ospf6_distance_ospf6_external, ospf6_distance_ospf6_external_cmd, "distance ospf6 external <1-255>",
      "Define an administrative distance\n"
      "OSPF6 Administrative distance\n"
      "External routes\n"
      "Distance for external routes\n") {
...
DEFUN(ospf6_distance_ospf6_external_intra, ospf6_distance_ospf6_external_intra_cmd, "distance ospf6 external <1-255> intra-area <1-255>",
      "Define an administrative distance\n"
      "OSPF6 Administrative distance\n"
      "External routes\n"
      "Distance for external routes\n"
...
DEFUN(ospf6_distance_ospf6_external_inter, ospf6_distance_ospf6_external_inter_cmd, "distance ospf6 external <1-255> inter-area <1-255>",
      "Define an administrative distance\n"
      "OSPF6 Administrative distance\n"
      "External routes\n"
      "Distance for external routes\n"
...
DEFUN(ospf6_distance_ospf6_external_intra_inter, ospf6_distance_ospf6_external_intra_inter_cmd, "distance ospf6 external <1-255> intra-area <1-255> inter-area <1-255>",
      "Define an administrative distance\n"
      "OSPF6 Administrative distance\n"
      "External routes\n"
      "Distance for external routes\n"
...
DEFUN(ospf6_distance_ospf6_external_inter_intra, ospf6_distance_ospf6_external_inter_intra_cmd, "distance ospf6 external <1-255> inter-area <1-255> intra-area <1-255>",
      "Define an administrative distance\n"
      "OSPF6 Administrative distance\n"
      "External routes\n"
      "Distance for external routes\n"
...
DEFUN(ospf6_distance_source, ospf6_distance_source_cmd, "distance <1-255> X:X::X:X/M",
...
DEFUN(no_ospf6_distance_source, no_ospf6_distance_source_cmd, "no distance <1-255> X:X::X:X/M",
...
DEFUN(ospf6_distance_source_access_list, ospf6_distance_source_access_list_cmd, "distance <1-255> X:X::X:X/M WORD",
      "Administrative distance\n"
      "Distance value\n"
      "IP source prefix\n"
      "Access list name\n") {
...
DEFUN(no_ospf6_distance_source_access_list, no_ospf6_distance_source_access_list_cmd, "no distance <1-255> X:X::X:X/M WORD",
      NO_STR "Administrative distance\n"
	     "Distance value\n"
	     "IP source prefix\n"
	     "Access list name\n") {
...
DEFUN(ospf6_interface_area, ospf6_interface_area_cmd, "interface IFNAME area A.B.C.D",
	...
	if(oi->area) {
		vty_out(vty, "%s already attached to Area %s%s", oi->interface->name, oi->area->name, VNL);
		return CMD_SUCCESS;
	}
...
DEFUN(no_ospf6_interface_area, no_ospf6_interface_area_cmd, "no interface IFNAME area A.B.C.D",
	...
	if(oi->area->area_id != area_id) {
		vty_out(vty, "Wrong Area-ID: %s is attached to area %s%s", oi->interface->name, oi->area->name, VNL);
		return CMD_SUCCESS;
	}
...
DEFUN(ospf6_stub_router_admin, ospf6_stub_router_admin_cmd, "stub-router administrative",
...
DEFUN(no_ospf6_stub_router_admin, no_ospf6_stub_router_admin_cmd, "no stub-router administrative",
      NO_STR "Make router a stub router\n"
...
DEFUN(ospf6_stub_router_startup, ospf6_stub_router_startup_cmd, "stub-router on-startup <5-86400>",
      "Make router a stub router\n"
      "Advertise inability to be a transit router\n"
...
DEFUN(no_ospf6_stub_router_startup, no_ospf6_stub_router_startup_cmd, "no stub-router on-startup",
      NO_STR "Make router a stub router\n"
	     "Advertise inability to be a transit router\n"
	     "Automatically advertise as stub-router on startup of OSPF6\n"
	     "Time (seconds) to advertise self as stub-router\n") {
...
DEFUN(ospf6_stub_router_shutdown, ospf6_stub_router_shutdown_cmd, "stub-router on-shutdown <5-86400>",
      "Make router a stub router\n"
      "Advertise inability to be a transit router\n"
...
DEFUN(no_ospf6_stub_router_shutdown, no_ospf6_stub_router_shutdown_cmd, "no stub-router on-shutdown",
      NO_STR "Make router a stub router\n"
	     "Advertise inability to be a transit router\n"
	     "Automatically advertise as stub-router before shutdown\n"
	     "Time (seconds) to advertise self as stub-router\n") {
...
static void ospf6_show(struct vty *vty, struct ospf6 *o) {
	...
	vty_out(vty, " OSPFv3 Routing Process (0) with Router-ID %s%s", router_id, VNL);
	...
	vty_out(vty,
		...
		o->spf_delay, VNL, o->spf_holdtime, VNL, o->spf_max_holdtime, VNL, o->spf_hold_multiplier, VNL);
	...
	if(o->ts_spf.tv_sec || o->ts_spf.tv_usec) {
		...
		vty_out(vty, " Last SPF duration %lld sec %lld usec%s", (long long) o->ts_spf_duration.tv_sec, (long long) o->ts_spf_duration.tv_usec, VNL);
	} else {
		vty_out(vty, "has not been run$%s", VNL);
	}
	threadtimer_string(now, o->t_spf_calc, buf, sizeof(buf));
	vty_out(vty, " SPF timer %s%s%s", (o->t_spf_calc ? "due in " : "is "), buf, VNL);
	...
	/* LSAs */
	vty_out(vty, " Number of AS scoped LSAs is %u%s", o->lsdb->count, VNL);

	/* Areas */
	vty_out(vty, " Number of areas in this router is %u%s", listcount(o->area_list), VNL);
...
DEFUN(show_ipv6_ospf6, show_ipv6_ospf6_cmd, "show ipv6 ospf6", SHOW_STR IP6_STR OSPF6_STR) {
...
DEFUN(show_ipv6_ospf6_route, show_ipv6_ospf6_route_cmd, "show ipv6 ospf6 route", SHOW_STR IP6_STR OSPF6_STR ROUTE_STR) {
	OSPF6_CMD_CHECK_RUNNING();
...
ALIAS(show_ipv6_ospf6_route, show_ipv6_ospf6_route_detail_cmd, "show ipv6 ospf6 route (X:X::X:X|X:X::X:X/M|detail|summary)",
      SHOW_STR IP6_STR OSPF6_STR ROUTE_STR "Specify IPv6 address\n"
					   "Specify IPv6 prefix\n"
					   "Detailed information\n"
					   "Summary of route table\n")

DEFUN(show_ipv6_ospf6_route_match, show_ipv6_ospf6_route_match_cmd, "show ipv6 ospf6 route X:X::X:X/M match",
      SHOW_STR IP6_STR OSPF6_STR ROUTE_STR "Specify IPv6 prefix\n"
...
DEFUN(show_ipv6_ospf6_route_match_detail, show_ipv6_ospf6_route_match_detail_cmd, "show ipv6 ospf6 route X:X::X:X/M match detail",
      SHOW_STR IP6_STR OSPF6_STR ROUTE_STR "Specify IPv6 prefix\n"
					   "Display routes which match the specified route\n"
					   "Detailed information\n") {
	const char *sargv[CMD_ARGC_MAX];
...
ALIAS(show_ipv6_ospf6_route_match, show_ipv6_ospf6_route_longer_cmd, "show ipv6 ospf6 route X:X::X:X/M longer",
      SHOW_STR IP6_STR OSPF6_STR ROUTE_STR "Specify IPv6 prefix\n"
					   "Display routes longer than the specified route\n")

DEFUN(show_ipv6_ospf6_route_match_detail, show_ipv6_ospf6_route_longer_detail_cmd, "show ipv6 ospf6 route X:X::X:X/M longer detail",
      SHOW_STR IP6_STR OSPF6_STR ROUTE_STR "Specify IPv6 prefix\n"
					   "Display routes longer than the specified route\n"
					   "Detailed information\n");

ALIAS(show_ipv6_ospf6_route, show_ipv6_ospf6_route_type_cmd, "show ipv6 ospf6 route (intra-area|inter-area|external-1|external-2)",
      SHOW_STR IP6_STR OSPF6_STR ROUTE_STR "Display Intra-Area routes\n"
					   "Display Inter-Area routes\n"
					   "Display Type-1 External routes\n"
					   "Display Type-2 External routes\n")

DEFUN(show_ipv6_ospf6_route_type_detail, show_ipv6_ospf6_route_type_detail_cmd, "show ipv6 ospf6 route (intra-area|inter-area|external-1|external-2) detail",
      SHOW_STR IP6_STR OSPF6_STR ROUTE_STR "Display Intra-Area routes\n"
					   "Display Inter-Area routes\n"
					   "Display Type-1 External routes\n"
					   "Display Type-2 External routes\n"
...
static int ospf6_distance_config_write(struct vty *vty) {
	...
	if(ospf6->distance_intra || ospf6->distance_inter || ospf6->distance_external) {
	...
	for(rn = route_top(ospf6->distance_table); rn; rn = route_next(rn)) {
		if((odistance = rn->info) != NULL) {
			char pstr[128];
			vty_out(vty, " distance %d %s %s%s", odistance->distance, prefix2str(&rn->p, pstr, sizeof(pstr)), odistance->access_list ? odistance->access_list : "", VTY_NEWLINE);
		}
	}
	return 0;
}
...
static int config_write_ospf6(struct vty *vty) {
	...
	if(ospf6->ref_bandwidth != OSPF6_REFERENCE_BANDWIDTH) {
		vty_out(vty, " auto-cost reference-bandwidth %d%s", ospf6->ref_bandwidth / 1000, VNL);
	}
	...
	for(ALL_LIST_ELEMENTS_RO(ospf6->area_list, j, oa)) {
		for(ALL_LIST_ELEMENTS_RO(oa->if_list, k, oi)) {
			vty_out(vty, " interface %s area %s%s", oi->interface->name, oa->name, VNL);
		}
	}
	vty_out(vty, "!%s", VNL);
	return 0;
