...
#define LINEAR_ALLOCATOR_ALIGN(value) (((value) + LINEAR_ALLOCATOR_ALIGNMENT - 1) & ~(LINEAR_ALLOCATOR_ALIGNMENT - 1));
 ...
 */
static inline void linear_allocator_init(linear_allocator_t *allocator, char *buf, size_t buf_len) {
 ...
 */
static inline void *linear_allocator_alloc(linear_allocator_t *allocator, size_t user_size) {
	size_t block_size;
 ...
 */
static inline void linear_allocator_free(linear_allocator_t *allocator, void *ptr) {
	linear_allocator_block_t *block;
