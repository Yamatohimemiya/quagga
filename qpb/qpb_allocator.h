 ...
 */
static inline void *qpb_alloc_ptr_array(qpb_allocator_t *allocator, size_t num_ptrs) {
 ...
 * Externs.
 */
extern void qpb_allocator_init_linear(qpb_allocator_t *, struct linear_allocator_t_ *);
...
#define QPB_INIT_STACK_ALLOCATOR(allocator) \
	do { \
		linear_allocator_init(&(lin_##allocator), lin_##allocator##_buf, sizeof(lin_##allocator##_buf)); \
