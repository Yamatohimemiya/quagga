...
#define TLV_HDR_TOP(lsah) (struct te_tlv_header *) ((char *) (lsah) + OSPF_LSA_HEADER_SIZE)

#define TLV_HDR_NEXT(tlvh) (struct te_tlv_header *) ((char *) (tlvh) + TLV_SIZE(tlvh))

#define TLV_HDR_SUBTLV(tlvh) (struct te_tlv_header *) ((char *) (tlvh) + TLV_HDR_SIZE)
