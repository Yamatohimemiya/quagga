...
extern int ospf_distribute_check_connected(struct ospf *, struct external_info *);
...
extern int ospf_distance_set(struct vty *, struct ospf *, const char *, const char *, const char *);
extern int ospf_distance_unset(struct vty *, struct ospf *, const char *, const char *, const char *);
