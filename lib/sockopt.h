...
extern int setsockopt_ipv4_multicast(int sock, int optname, unsigned int mcast_addr, ifindex_t ifindex);
...
extern int sockopt_tcp_signature(int sock, union sockunion *su, const char *password);
