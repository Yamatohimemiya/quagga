...
extern struct prefix *sockunion2prefix(const union sockunion *dest, const union sockunion *mask);
...
#define PREFIX_COPY_IPV4(DST, SRC) *((struct prefix_ipv4 *) (DST)) = *((const struct prefix_ipv4 *) (SRC));
...
extern void apply_mask_ipv6(struct prefix_ipv6 *);
	...
	#define PREFIX_COPY_IPV6(DST, SRC) *((struct prefix_ipv6 *) (DST)) = *((const struct prefix_ipv6 *) (SRC));
