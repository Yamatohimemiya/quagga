...
void ripng_aggregate_increment(struct route_node *child, struct ripng_info *rinfo) {
...
void ripng_aggregate_decrement(struct route_node *child, struct ripng_info *rinfo) {
	struct route_node *np;
	struct ripng_aggregate *aggregate;
